    ...
    public void run() {
        if (studentLabRepo.count() == 0) {
            ...
            studentLabRepo.saveAll(Arrays.asList(
                ...
                new StudentLab(students.get(0), labRepo.findByName("Вывод информации из БД на 5 страниц").get(0), new Date(),
                        labRepo.findByName("Вывод информации из БД на 5 страниц").get(0).getScores()),
